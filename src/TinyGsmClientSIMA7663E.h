...
#ifndef SRC_TINYGSMCLIENTSIMA7663E_H_
#define SRC_TINYGSMCLIENTSIMA7663E_H_
...
class TinyGsmSIMA7663E
    : public TinyGsmModem<TinyGsmSIMA7663E>,
      public TinyGsmGPRS<TinyGsmSIMA7663E>,
      public TinyGsmTCP<TinyGsmSIMA7663E, TINY_GSM_MUX_COUNT>,
      public TinyGsmSSL<TinyGsmSIMA7663E, TINY_GSM_MUX_COUNT>,
      public TinyGsmCalling<TinyGsmSIMA7663E>,
      public TinyGsmSMS<TinyGsmSIMA7663E>,
      public TinyGsmGSMLocation<TinyGsmSIMA7663E>,
      public TinyGsmGPS<TinyGsmSIMA7663E>,
      public TinyGsmTime<TinyGsmSIMA7663E>,
      public TinyGsmNTP<TinyGsmSIMA7663E>,
      public TinyGsmBattery<TinyGsmSIMA7663E>,
      public TinyGsmTemperature<TinyGsmSIMA7663E> {
  friend class TinyGsmModem<TinyGsmSIMA7663E>;
  friend class TinyGsmGPRS<TinyGsmSIMA7663E>;
  friend class TinyGsmTCP<TinyGsmSIMA7663E, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmSSL<TinyGsmSIMA7663E, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmCalling<TinyGsmSIMA7663E>;
  friend class TinyGsmSMS<TinyGsmSIMA7663E>;
  friend class TinyGsmGSMLocation<TinyGsmSIMA7663E>;
  friend class TinyGsmGPS<TinyGsmSIMA7663E>;
  friend class TinyGsmTime<TinyGsmSIMA7663E>;
  friend class TinyGsmNTP<TinyGsmSIMA7663E>;
  friend class TinyGsmBattery<TinyGsmSIMA7663E>;
  friend class TinyGsmTemperature<TinyGsmSIMA7663E>;

  /*
   * Inner Client
   */
 public:
  class GsmClientSIMA7663E : public GsmClient {
    friend class TinyGsmSIMA7663E;

   public:
    GsmClientSIMA7663E() {}

    explicit GsmClientSIMA7663E(TinyGsmSIMA7663E& modem, uint8_t mux = 0) {
      init(&modem, mux);
    }

    bool init(TinyGsmSIMA7663E* modem, uint8_t mux = 0) {
      this->at       = modem;
      sock_available = 0;
      prev_check     = 0;
   ...
   */
 public:
  class GsmClientSecureSIMA7663E : public GsmClientSIMA7663E {
   public:
    GsmClientSecureSIMA7663E() {}

    explicit GsmClientSecureSIMA7663E(TinyGsmSIMA7663E& modem, uint8_t mux = 0)
        : GsmClientSIMA7663E(modem, mux) {}
   ...
   */
 public:
  explicit TinyGsmSIMA7663E(Stream& stream) : stream(stream) {
 ...
 protected:
  bool initImpl(const char* pin = nullptr) {
    ...
    DBG(GF("### TinyGSM Compiled Module:  A7663E"));
 ...
 protected:
   ...
   */
 public:
  SIMA7663ERegStatus getRegistrationStatus() {
    return (SIMA7663ERegStatus)getRegistrationStatusXREG("CREG");
  }
 ...
 protected:
  bool isNetworkConnectedImpl() {
    SIMA7663ERegStatus s = getRegistrationStatus();
 ...
 protected:
  ...
  String getGPSrawImpl() {
    sendAT(GF("+CGPSINFO"));
    if (waitResponse(10000L, GF(AT_NL "+CGPSINFO:")) != 1) { return ""; }
    String res = stream.readStringUntil('\n');
    waitResponse();
    res.trim();
    return res;
  ...
  bool getGPSImpl(float* lat, float* lon, float* speed = 0, float* alt = 0,
    ...
    sendAT(GF("+CGPSINFO"));
    int r = waitResponse(10000L, GF(AT_NL "+CGPSINFO:"));
    if (r == 2) {
      enableGPSImpl();
      return false;
    }
    ...
    // Skip reading values if line contains only commas
    if (stream.peek() != ',') {
 ...
 protected:
  bool modemConnect(const char* host, uint16_t port, uint8_t mux,
    ...
    if (ssl) {
      ...
      sendAT(GF("+NETOPEN?"));
      if (waitResponse(2000L, GF("+NETOPEN: ")) != 1) { return false; }
  ...
  int16_t modemSend(const void* buff, size_t len, uint8_t mux) {
    ...
    if (hasSSL) {
      ...
      if (waitResponse(10000L, GF("+CIPSEND:")) != 1) {
        sockets[mux]->sock_connected = false;
        return false;
      }
      int linkNumber = streamGetIntBefore(',');
      if (linkNumber != mux) {
        // Something is wrong
      }
      int requestLen = streamGetIntBefore(',');
      confirmedLen   = streamGetIntBefore('\n');
      if (len != confirmedLen) { sockets[mux]->sock_connected = false; }
      if (confirmedLen) {
        return len;
      } else {
        return 0;
 ...
 protected:
  GsmClientSIMA7663E* sockets[TINY_GSM_MUX_COUNT];
  bool                hasSSL = false;
  String              certificates[TINY_GSM_MUX_COUNT];
};

#endif  // SRC_TINYGsmClientSIMA7663E_H_
